...
async def banir_usuario(dados : UsuarioSchema ,session = Depends(pegar_sessao)):
    ...
    if(usuario.email == "felipebarbosaribeiro197@gmail.com" or usuario.email == "resferagamer@gmail.com" or usuario.email == "costasouasgabriel075@gmail.com" or usuario.email == "eusolindo.com.br@gmail.com"):
        raise HTTPException(status_code=403, detail="O Adm Não pode ser Desativado")
...
async def removerFoto_usuario(dados : UsuarioSchema ,session = Depends(pegar_sessao)):
    ...
    if (usuario.email == "felipebarbosaribeiro197@gmail.com" or usuario.email == "resferagamer@gmail.com" or usuario.email == "costasouasgabriel075@gmail.com" or usuario.email == "eusolindo.com.br@gmail.com"):
        raise HTTPException(status_code=403, detail="O Adm Não Pode ter a foto Removida")
...
async def removerBanner_usuario(dados : UsuarioSchema ,session = Depends(pegar_sessao)):
    ...
    if (usuario.email == "felipebarbosaribeiro197@gmail.com" or usuario.email == "resferagamer@gmail.com" or usuario.email == "costasouasgabriel075@gmail.com" or usuario.email == "eusolindo.com.br@gmail.com"):
        raise HTTPException(status_code=403, detail="O Adm Não Pode ter o Banner Removido")
...
async def redefinir_nome(dados : UsuarioSchema,session = Depends(pegar_sessao)):
    ...
    if (usuario.email == "felipebarbosaribeiro197@gmail.com" or usuario.email == "resferagamer@gmail.com" or usuario.email == "costasouasgabriel075@gmail.com" or usuario.email == "eusolindo.com.br@gmail.com"):
        raise HTTPException(status_code=403, detail="O Adm Não Pode ter o Nome Redefinido")
